...
// Componente centralizado para renderizar iconos SVG
// Extraído de la función renderIcon duplicada en Inicio, Programas y QuienesSomos

import React from 'react'
>>>>>>> 5015b5b64c3fee8ac55576bf0240728d9af7c1c0
...
<<<<<<< HEAD
/*
  Componente para renderizar iconos SVG según el tipo
  Centraliza todos los iconos usados en la aplicación
 */
export function IconRenderer({ tipo, className = "size-6" }: IconRendererProps) {
  const iconos: { [key: string]: JSX.Element } = {
=======

/**
 * Componente para renderizar iconos SVG de forma consistente
 * Centraliza todos los iconos utilizados en la aplicación
 * 
 * @param tipo - Tipo de icono a renderizar
 * @param className - Clases CSS adicionales para el SVG
 */
export function IconRenderer({ tipo, className = "w-5 h-5" }: IconRendererProps) {
  const iconos = {
    // Iconos de contacto
>>>>>>> 5015b5b64c3fee8ac55576bf0240728d9af7c1c0
    ubicacion: (
...
=======
  ...
  const iconPath = iconos[tipo as keyof typeof iconos]
